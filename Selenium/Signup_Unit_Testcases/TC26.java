...
/**
 * Check the password limit when enter value less than 6 character
 * Test step:
 * 1. Go to: https://giaybom.com/
 * 2. Click Register
 * 3. In password field, enter "12345" and fill all other field
...
public class TC26 {
    public static void tc26(){
        ...
        try {
            ...
            fieldEmail.sendKeys("KIDDLEzE615236@gmail.com");
