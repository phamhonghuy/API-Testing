...
/**
 * Enter an invalid email IP address
 * Test step:
 * 1. Go to: https://giaybom.com/
 * 2. Click Register
 * 3. In Email field, enter "anh@111.222.333.4@gmail.com" and fill all other field
...
public class TC20 {
    public static void tc20(){
        ...
        try {
            ...
            fieldEmail.sendKeys("anh@111.222.333.4@gmail.com");
