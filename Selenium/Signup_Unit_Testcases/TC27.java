...
/**
 * Check the password limit when enter value more than 32 character
 * Test step:
 * 1. Go to: https://giaybom.com/
 * 2. Click Register
 * 3. In password field, enter "012345678901234567890123456789012345" and fill all other field
...
public class TC27 {
    public static void tc27(){
        ...
        try {
            ...
            fieldEmail.sendKeys("IUMINIUM6z7Ookela55ZTC245a@gmail.com");
            ...
            fieldPassword.sendKeys("012345678901234567890123456789012345");
            Thread.sleep(3000);
            //Step 4: Click Submit
