...
/**
 * Check SurName cann't have a space at first character
 * Test step:
 * 1. Go to: https://giaybom.com/
 * 2. Click Register
 * 3. In SurName field, enter " Huynh Phuc" and fill all other field
...
public class TC16 {
    public static void tc16(){
        ...
        try {
            ...
            fieldEmail.sendKeys("WWjlasimu76738asd7@gmail.com");
