...
/**
 * Check login with a not exist email (not yet register this email)
 * Test step:
 * 1. Go to: https://giaybom.com/
 * 2. Click Log in
 * 3. In email field, enter "anhanhanhanhZDA@gmail.com" and fill all other field
...
public class TC33 {
    public static void tc32(){
        ...
        try {
            ...
            fieldEmail.sendKeys("anhanhanhanhZDA@gmail.com");
